            ...
            <div class="main-content">
                ...
                <div class="content content2">
                    ...
                    <h2>Day 3: Powering the 8266 Wifi chip, downloading the drivers and libraries</h2>
                        <p>This process took a lot of time for me get working because I wasn't aware I need libraries and drivers for the chip to work. I knew the chip needed 3.3 volts to be powered, as well as a ground. The Arduino also has a spot for 3.3v, but I read online that sometimes pulling power from the 3.3v causes issues with the wifi chip working consistently. This caused me to build a voltage regulator with an input of 5v from the Arduino and an output of 3.3v with a 1uf capacitor and .01cf capacitor in series. This did work but I also tried powering the wifi chip from the 3.3v directly and never experienced any powering issues so I removed the voltage regulator from the circuit. Next, I needed the appropriate drivers, and libraries to get the chip in working order. I read the documentation for about 4 hours and experimented until I was able to upload a simple blink program. Once I knew I could do that I knew I could upload a more complex program.
                        </p>
                    </div>
                </div>
                <div class="content content1">
